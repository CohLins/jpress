...
CREATE TABLE `article` (
  ...
  `pdf_url` varchar(512) DEFAULT NULL COMMENT 'PDF路径',
  PRIMARY KEY (`id`),
...
# Dump of table personal_letter
# ------------------------------------------------------------
CREATE TABLE `personal_letter` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `chat_id` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '聊天ID',
  ...
  `pic_url` varchar(512) COLLATE utf8_bin DEFAULT NULL,
  `status` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `send_status` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '发送者状态',
  `accept_status` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '接受者状态',
  `create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='私信表';
